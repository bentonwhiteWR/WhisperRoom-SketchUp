...
Right-door booth `Group#27` (Option 2, visible only in FrontRender/FrontDims RightDoor): 6 old foam deleted, all 25 acoustic pieces copied with identical local transforms (`g27copy.rb`); local wall frames verified identical. It still has NO MJP and NO HEPA.
