# @title Build Booth MDL 4230 E
# GENERATED by scripts/gen-booth.py — regenerate, don't hand-edit.
#
# MDL 4230 E  ("Sound Booth · 3.5'×2.5'")
#   exterior  44.0" x 32.0"      interior 35.5" x 23.5"
...
module WR_BOOTH_4230_E
  ...
  PARTS = [
    { :k=>'panel', :id=>'N0', :side=>'N', :sk=>'VNT', :pack=>nil, :x=>4.25, :y=>27.75, :dx=>35.5, :dy=>1.0 },
    { :k=>'panel', :id=>'S0', :side=>'S', :sk=>'DRFRM', :pack=>nil, :x=>4.25, :y=>3.25, :dx=>35.5, :dy=>1.0 },
    { :k=>'panel', :id=>'E0', :side=>'E', :sk=>'SOLID', :pack=>nil, :x=>39.75, :y=>4.25, :dx=>1.0, :dy=>23.5 },
    { :k=>'panel', :id=>'W0', :side=>'W', :sk=>'SOLID', :pack=>nil, :x=>3.25, :y=>4.25, :dx=>1.0, :dy=>23.5 }
  ]
  ...
  def self.build
    ...
    model.start_operation("Build MDL 4230 E", true)
    ...
    puts ""
    puts "MDL 4230 E built."
    puts "  exterior 44.0\" x 32.0\"   interior 35.5\" x 23.5\""
    ...
    puts "  NOTE: E wall [28] -> [23.5] (scaled), + 0 seal(s) = 23.50' run"
    puts "  NOTE: W wall [28] -> [23.5] (scaled), + 0 seal(s) = 23.50' run"
