# @title Build Booth MDL 4242 E
# GENERATED by scripts/gen-booth.py — regenerate, don't hand-edit.
#
# MDL 4242 E  ("Sound Booth · 3.5'×3.5'")
#   exterior  44.0" x 44.0"      interior 35.5" x 35.5"
...
module WR_BOOTH_4242_E
  ...
  PARTS = [
    { :k=>'panel', :id=>'N0', :side=>'N', :sk=>'VNT', :pack=>nil, :x=>4.25, :y=>39.75, :dx=>35.5, :dy=>1.0 },
    { :k=>'panel', :id=>'S0', :side=>'S', :sk=>'DRFRM', :pack=>nil, :x=>4.25, :y=>3.25, :dx=>35.5, :dy=>1.0 },
    { :k=>'panel', :id=>'E0', :side=>'E', :sk=>'SOLID', :pack=>nil, :x=>39.75, :y=>4.25, :dx=>1.0, :dy=>35.5 },
  ...
  def self.build
    ...
    model.start_operation("Build MDL 4242 E", true)
    ...
    puts ""
    puts "MDL 4242 E built."
    puts "  exterior 44.0\" x 44.0\"   interior 35.5\" x 35.5\""
    puts "  4 wall panels + 0 mid-wall seam seals, panels 1\" x 81\" tall"
    puts "  packing list lists 4 wall panels — agrees"
    puts "  NOTE: N wall [40] -> [35.5] (scaled), + 0 seal(s) = 35.50' run"
    puts "  NOTE: S wall [40] -> [35.5] (scaled), + 0 seal(s) = 35.50' run"
