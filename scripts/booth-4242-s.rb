# @title Build Booth MDL 4242 S
# GENERATED by scripts/gen-booth.py — regenerate, don't hand-edit.
#
# MDL 4242 S  ("Sound Booth · 3.5'×3.5'")
#   exterior  44.0" x 44.0"      interior 40.0" x 40.0"
...
module WR_BOOTH_4242_S
  ...
  PARTS = [
    ...
    { :k=>'panel', :id=>'E0', :side=>'E', :sk=>'SOLID', :pack=>nil, :x=>42.0, :y=>2.0, :dx=>1.0, :dy=>40.0 },
  ...
  def self.build
    ...
    model.start_operation("Build MDL 4242 S", true)
    ...
    puts ""
    puts "MDL 4242 S built."
    puts "  exterior 44.0\" x 44.0\"   interior 40.0\" x 40.0\""
