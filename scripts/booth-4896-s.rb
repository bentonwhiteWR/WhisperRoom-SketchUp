# @title Build Booth MDL 4896 S
# GENERATED by scripts/gen-booth.py — regenerate, don't hand-edit.
#
# MDL 4896 S  ("Sound Booth · 4'×8'")
#   exterior  98.0" x 50.0"      interior 94.0" x 46.0"
...
module WR_BOOTH_4896_S
  ...
  PARTS = [
    ...
    { :k=>'seal', :id=>'N-seal0', :side=>'N', :sk=>'SEAL', :pack=>'Std mid-wall seam seal', :x=>48.0, :y=>48.0, :dx=>2.0, :dy=>1.0 },
    { :k=>'panel', :id=>'N1', :side=>'N', :sk=>'VNT', :pack=>nil, :x=>50.0, :y=>48.0, :dx=>46.0, :dy=>1.0 },
  ...
  def self.build
    ...
    model.start_operation("Build MDL 4896 S", true)
    ...
    puts ""
    puts "MDL 4896 S built."
    puts "  exterior 98.0\" x 50.0\"   interior 94.0\" x 46.0\""
