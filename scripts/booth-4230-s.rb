# @title Build Booth MDL 4230 S
# GENERATED by scripts/gen-booth.py — regenerate, don't hand-edit.
#
# MDL 4230 S  ("Sound Booth · 3.5'×2.5'")
#   exterior  44.0" x 32.0"      interior 40.0" x 28.0"
...
module WR_BOOTH_4230_S
  ...
  PARTS = [
    { :k=>'panel', :id=>'N0', :side=>'N', :sk=>'VNT', :pack=>nil, :x=>2.0, :y=>30.0, :dx=>40.0, :dy=>1.0 },
    { :k=>'panel', :id=>'S0', :side=>'S', :sk=>'DRFRM', :pack=>nil, :x=>2.0, :y=>1.0, :dx=>40.0, :dy=>1.0 },
    { :k=>'panel', :id=>'E0', :side=>'E', :sk=>'SOLID', :pack=>nil, :x=>42.0, :y=>2.0, :dx=>1.0, :dy=>28.0 },
    { :k=>'panel', :id=>'W0', :side=>'W', :sk=>'SOLID', :pack=>nil, :x=>1.0, :y=>2.0, :dx=>1.0, :dy=>28.0 }
  ]
  ...
  def self.build
    ...
    model.start_operation("Build MDL 4230 S", true)
    ...
    puts ""
    puts "MDL 4230 S built."
    puts "  exterior 44.0\" x 32.0\"   interior 40.0\" x 28.0\""
